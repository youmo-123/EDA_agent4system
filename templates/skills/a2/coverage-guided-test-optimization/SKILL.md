---
name: coverage-guided-test-optimization
role: A2
description: 解读 coverage result，产生 gap 分析与下一测试计划。
inputs: []
outputs: []
allowed_tools: []
...
# A2 · coverage-guided-test-optimization

## 何时加载

解读 coverage result，产生 gap 分析与下一测试计划。
