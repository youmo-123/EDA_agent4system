---
name: failure-attribution-and-minimization
role: A2
description: 对失败用例进行归因与 delta-debugging 最小化。
inputs: []
outputs: []
allowed_tools: []
...
# A2 · failure-attribution-and-minimization

## 何时加载

对失败用例进行归因与 delta-debugging 最小化。
