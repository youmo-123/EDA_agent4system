---
name: verification-skeleton-generation
role: A2
description: 生成 driver/monitor/scoreboard 与 reference-model 接口。
inputs: []
outputs: []
allowed_tools: []
...
# A2 · verification-skeleton-generation

## 何时加载

生成 driver/monitor/scoreboard 与 reference-model 接口。
